...
"X-GitHub-Api-Version" => "2022-11-28"
  ...
  url "\#{GitHubHelper.release_asset_url("traverseMemberAccounts/v0.1.0", "traverseMemberAccounts-0.1.0.tar.gz")}",
    headers: [
      "Accept: application/octet-stream",
      "Authorization: Bearer \#{GitHubHelper.token}",
      "X-GitHub-Api-Version: 2022-11-28"
    ]
  sha256 "3424518177c71da5d29461d405f72a54fc88cae21c6c1e612b2844ee11ad6aa6"
