class SonarcloudCoverageCheck < Formula
...
"X-GitHub-Api-Version" => "2022-11-28"
  ...
  url "#{GitHubHelper.release_asset_url("sonarcloud-coverage-check/v0.1.0", "sonarcloud-coverage-check-0.1.0.tar.gz")}",
    headers: [
      "Accept: application/octet-stream",
      "Authorization: Bearer #{GitHubHelper.token}",
      "X-GitHub-Api-Version: 2022-11-28"
    ]
  sha256 "9269205dc0ebf9c6a1efd5fc23093e84c3ae97465a9bcaad590eb0a5516fe2b7"

  def install
    bin.install "sonarcloud-coverage-check.sh" => "sonarcloud-coverage-check"
  end

  test do
    system "#{bin}/sonarcloud-coverage-check", "--help"
  end
end
